...
// Genera un resumen extractivo: Azure elige las oraciones mas representativas del texto.
exports.resumirTexto = async (texto, numOraciones = 2) => {
  try {
    ...
    // Arma el trabajo asincrono que Azure debe ejecutar para resumir el texto.
